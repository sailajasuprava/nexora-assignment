  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-[60vh]">
        <p className="text-lg text-gray-600">Loading pizzas...</p>
      </div>
    );
  }
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-yellow-100">
                    ...
                    <Link to={`/pizza/${pizza._id}`}>
                      <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-gray-900 font-semibold py-2 px-4 rounded-full transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105">
                        See Details
                      </button>
                    </Link>
                  </div>
